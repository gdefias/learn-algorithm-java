...
public class BuildTree {
    ...
    private static TreeNode buildTree(List<Integer> preorderList, List<Integer> inorderList) {
        //出口  中序遍历序列访问完
        ...
        root.left = buildTree(preorderList, inorderList.subList(0, mid));
        ...
        root.right = buildTree(preorderList, inorderList.subList(mid + 1, inorderList.size()));
    ...
    public static TreeNode buildTree2(int[] preorder, int[] inorder) {
        ...
        return buildTree2(preorder, 0, preorder.length-1, inorder, 0, inorder.length-1, inordermap);
    }

    public static TreeNode buildTree2(int[] preorder, int i, int j, int[] inorder, int p, int q, HashMap<Integer, Integer> map) {
        //出口 前序遍历序列访问完
        if(i>j) {
            return null;
        }
        ...
        //递归重建左右子树
        root.left = buildTree2(preorder, lefti, leftj, inorder, p, inordermid-1, map);
        root.right = buildTree2(preorder, righti, rightj, inorder, inordermid+1, q, map);
