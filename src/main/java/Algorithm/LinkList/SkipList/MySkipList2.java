package Algorithm.LinkList.SkipList;
...
public class MySkipList2<T extends Comparable<? super T>> {
    ...
    public static void main(String[] args) {
        MySkipList2<Integer> skipList = new MySkipList2<Integer>(60);
        skipList.add(1);
        skipList.add(3);
        skipList.add(2);
        skipList.add(4);
